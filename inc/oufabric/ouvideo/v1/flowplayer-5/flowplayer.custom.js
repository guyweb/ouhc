         ...
         load: function(video) {
            ...
            if (api) {
               ...
               var opts = {
                  ...
                  callback: "_flowplayer_callback."+ callbackId
               };
               if (root.data("origin")) {
               ...
               window._flowplayer_callback = window._flowplayer_callback || {};
               window._flowplayer_callback[callbackId] = function(type, arg) {
